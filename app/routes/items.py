...
async def create_item(
    ...
    try:
        # The owner's ID is taken from the authenticated user's token
...
async def search_items(
    ...
    # This endpoint can be enhanced with text search capabilities in the service layer
    return await item_service.search_items_by_text(q, category, db)